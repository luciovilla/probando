...
PROJECT_SLUG = 'probando'

# Project name to be used in file paths
PROJECT_FILENAME = 'probando'

# The name of the repository containing the source
REPOSITORY_NAME = 'probando'
GITHUB_USERNAME = 'luciovilla'
REPOSITORY_URL = 'git@github.com:%s/%s.git' % (GITHUB_USERNAME, REPOSITORY_NAME)
REPOSITORY_ALT_URL = None # 'git@bitbucket.org:nprapps/%s.git' % REPOSITORY_NAME'

# Project name used for assets rig
# Should stay the same, even if PROJECT_SLUG changes
ASSETS_SLUG = 'probando'

"""
DEPLOYMENT
"""
PRODUCTION_S3_BUCKET = {
    'bucket_name': 'apps.hoylabs.com',
    'region': 'us-east-1'
}

STAGING_S3_BUCKET = {
    'bucket_name': 'stage-apps.hoylabs.com',
    'region': 'us-east-1'
}

ASSETS_S3_BUCKET = {
    'bucket_name': 'assets.apps.hoylabs.com',
    'region': 'us-east-1'
}
...
COPY EDITING
"""
COPY_GOOGLE_DOC_URL = 'https://docs.google.com/spreadsheet/ccc?key=0AsyzMzlXxsN9dE1SRWFlRV9NaTc5MDV6cDlKVDh0RWc#gid=1'
...
# DISQUS_UUID = 'fcc3e687-7029-11e4-9435-6476ba9152e8'
